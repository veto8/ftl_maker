% ftl-maker(SECTION) | User Commands
%
% "April 21 2026"
...
ftl-maker - program to do something

# SYNOPSIS

**ftl-maker** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**ftl-maker** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **ftl-maker** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**ftl-maker** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    ftl-maker. See **foo.conf**(5) for further details.
...
**ftl-maker** provides some return codes, that can be used in scripts:
